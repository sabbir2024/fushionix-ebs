...
const CustomerTable = ({ customers, isPending, refetch, handleDelete }) => {
    return (
        <div>
                                ...
                                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    <thead className="bg-gray-50 dark:bg-gray-800">
                                        <tr>
                                            ...
                                            <th scope="col" className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Guardian</th>
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                        {
                                            isPending ?
                                                ...
                                                (
                                                    customers ?
                                                        (
                                                            customers?.map((customer, index) => <CustomerTableBody
                                                                key={customer._id}
